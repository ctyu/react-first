...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mockData = __webpack_require__(3);

	var _CommentList = __webpack_require__(4);
	...
	var CommentBox = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(_CommentList.CommentList, { list: this.props.list }),
	            React.createElement(_CommentList.CommentForm, null)
	        );
	    }
	});
	ReactDom.render(React.createElement(CommentBox, { list: _mockData.data }), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var comments = list.map(function (val, i) {
	            return React.createElement(
	                _Comment.Comment,
	                { key: i, author: val.author },
	                val.text
	            );
	        });
	        return React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comment = React.createClass({
	    ...
	    htmlMarkup: function htmlMarkup() {
	        var _html = marked(this.props.children.toString(), { sanitize: true });
	        return { __html: _html };
	    },
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement('span', { dangerouslySetInnerHTML: this.htmlMarkup() })
	        );
	    }
	});
